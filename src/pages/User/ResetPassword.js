...
// 1st import the needed thing such as field, button, link, formik, and bades

//2nd declare a variable before return 
const ResetPassword = () => {
  const [searchParams] = useSearchParams();
const verifyToken = searchParams.get("token"); // extract the token from the url 
...
// validion for the field using yup
